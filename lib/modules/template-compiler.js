...
module.exports = function compile (template, { transformToRequire = {}, delimiters = []} = {}) {
  let compilerOptions = {
    modules: [{
  ...
  if (delimiters.length !== 0) {
      compilerOptions.delimiters = delimiters;
  }
  const compiled = compiler.compile(template, compilerOptions);
